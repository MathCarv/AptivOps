            ...
            <View style={styles.footer}>
                ...
                <View style={styles.button}>
                    <TouchableOpacity onPress={() => navigation.navigate("Configurações")}>
                        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                            <Image source={require("../../assets/configuracoes-icon.png")} style={{ width: 30, height: 30, marginLeft: 35, borderColor: 'blue', borderWidth: 1, borderRadius: 15}} />
                        </View>
                        <Text style={styles.buttonTextBlue}>Configurações</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
